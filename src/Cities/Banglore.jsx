    ...
    <>
      <section>
        <div className="relative ">
          <img
            src="\Images\Centers_Image\Banglore_banner.jpg"
            alt=""
      ...
      <section className="mx-5 lg:mx-30 mt-10 lg:mt-20">
          ...
          <div>
            <h1 className="lg:text-2xl text-xl font-semibold  mb-5 lg:mb-5">
              ...
              <span className="text-sky-500">
                best blood test center in Bangalore?
              </span>
            </h1>
            ...
            <h1 className="lg:text-3xl text-xl font-semibold mt-5 mb-5 lg:mb-5">
              Blood Test Home Collection Services in Bangalore
            </h1>
        ...
        <div className=" lg:mt-20 mt-10 ">
          <h1 className="lg:text-2xl text-xl font-semibold mt-10 lg:mt-20 mb-5 lg:mb-10">
            Why Choose{" "}
            <span className="text-sky-500">
              TRUtest diagnostics in Bangalore?
            </span>
          </h1>
          <WhyChoose />
        </div>
        ...
        <div className="mx-3 lg:mx-30 py-10 lg:py-20 mb-20">
          ...
          <div className="rounded-2xl p-5 lg:p-5 bg-white w-auto lg:w-100 ">
            <h1 className="mb-3 font-semibold text-lg lg:text-2xl  text-gray-700 bg">
              TRUtest Blood Test Center - Bangalore
            </h1>
            <p>
            ...
            <div className="flex justify-between">
              ...
              <a
                href="https://www.google.com/maps/place/Bengaluru,+Karnataka/@12.9539456,77.4661259,11z/data=!3m1!4b1!4m6!3m5!1s0x3bae1670c9b44e6d:0xf8dfc3e8517e4fe0!8m2!3d12.9628669!4d77.577509!16zL20vMDljMTc?entry=ttu&g_ep=EgoyMDI2MDIwOC4wIKXMDSoASAFQAw%3D%3D"
                target="_blank"
      ...
      <section className="mx-5 lg:mx-30 mt-5 lg:mt-20">
        <h1 className="lg:mb-5 mb-3 text:lg lg:text-2xl font-semibold">
          ...
          <span className="text-sky-500">
            Your Trusted Pathology Lab Center in Bangalore
          </span>
        </h1>
        ...
        <h1 className="lg:mb-5 mb-3 text:lg lg:text-2xl font-semibold">
          Your Trusted{" "}
          <span className="text-sky-500">Blood Test Centre in Bangalore</span>
        </h1>
        <p className="mb-7 lg:mb-10 text-sm lg:text-base text-gray-800 ">
